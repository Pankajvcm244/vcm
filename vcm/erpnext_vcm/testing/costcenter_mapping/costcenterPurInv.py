...
# script apps/vcm/vcm/erpnext_vcm/testing/purchaseINVcommand-2.log
# bench --site test.vcmerp.in execute vcm.erpnext_vcm.testing.costcenterPurInv.update_sinv_cost_center
# # exit
...
def update_sinv_cost_center():
    ...
    #file_path = "/home/ubuntu/frappe-bench/apps/vcm/vcm/erpnext_vcm/testing/CostCentresCorrectionPooja.xlsx"  
    
    #file_path = "/home/ubuntu/frappe-bench/apps/vcm/vcm/erpnext_vcm/testing/pankajPI-1.xlsx"  
    ...
    for index, row in df.iterrows():
        ...
        try:
            # Fetch Sales Invoice
            doc = frappe.get_doc("Purchase Invoice", doc_ID_no)
