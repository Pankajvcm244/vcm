...
# bench --site test.vcmerp.in execute vcm.erpnext_vcm.testing.costcenterMAT.update_sinv_cost_center
# # exit
...
def update_sinv_cost_center():
    ...
    file_path = "/home/ubuntu/frappe-bench/apps/vcm/vcm/erpnext_vcm/testing/pankajMAT-1.xlsx"  # Change as needed
    ...
    for index, row in df.iterrows():
        ...
        try:
            # Fetch Sales Invoice
            doc = frappe.get_doc("Stock Entry", doc_ID_no)
